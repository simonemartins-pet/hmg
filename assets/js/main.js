...
document.addEventListener('DOMContentLoaded', function() {
    console.log("Scripts carregados com sucesso!"); // Teste de console
    ...
    // --- LÓGICA DO FAQ (Só roda na página FAQ) ---
    const faqContainer = document.getElementById('faq-content-container');
    if (faqContainer) {
        initFAQ();
    }

    // --- LÓGICA DO FORMULÁRIO (Só roda na Index) ---
    const form = document.getElementById('form-contato');
    if (form) {
        // Tornamos a função global para o botão encontrar
